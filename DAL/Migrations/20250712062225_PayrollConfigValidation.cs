...
{
    /// <inheritdoc />
    public partial class PayrollConfigValidation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayrollConfigs", x => x.ConfigId);
                    table.ForeignKey(
                        name: "FK_PayrollConfigs_Employee_EmployeeId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayrollConfig", x => x.ConfigId);
                    table.ForeignKey(
